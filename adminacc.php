...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <div class="flex items-center w-full p-1 pl-6"
        ...
        <div class="flex items-center justify-center"
          style="display: flex; align-items: center; justify-content: center; auto;">
  ...
  <main id="main" class="main">
    <div class="alert-container"
      style="position: fixed; top: 0; right: 0; z-index: 1050; margin: 60px; display: flex; justify-content: flex-end;">
