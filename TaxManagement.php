...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-8">
        <div class="row">
          <!-- Table displaying tax payment details -->
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Upcoming Tax Payments</h5>
                <table class="table table-striped" id="taxTable">
                  ...
                  <tbody>
                    <?php
                      // Query to fetch upcoming tax payments from the database
                      $sql = "SELECT payment_date, amount FROM tax_payments ORDER BY payment_date ASC";
