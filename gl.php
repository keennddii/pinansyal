...
<main id="main" class="main">
    ...
    <input type="number" step="0.01" name="debit" placeholder="Debit Amount" required>
    <input type="number" step="0.01" name="credit" placeholder="Credit Amount" required>
    <input type="text" name="module" placeholder="Module (e.g., Accounts Receivable)" required>
